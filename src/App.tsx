...
export default function App() {
  ...
  const sendOrder = async () => {
    ...
    const total = form.payment === 'stars' ? `${starsPrice(finalTotal)} ⭐ Stars` : `${finalTotal}₽`
  ...
  return (
    <div style={{
      background: '#07080f', minHeight: '100vh', width: '100%', color: '#fff',
        ...
        <motion.div initial={{ opacity: 0, x: 10 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.15 }}
          ...
          {['Качество', 'Доставка РФ'].map((t, i) => (
            <span key={i} style={{
              ...
              color: '#f5c76a', padding: '4px 10px', borderRadius: 20, fontSize: 10, fontWeight: 600,
            }}>{t}</span>
          ))}
        </motion.div>
      </motion.div>
      ...
      <div style={{ padding: '20px 16px 0' }}>
        <motion.p
          ...
          {activeCategory === 'all' ? `Все товары · ${products.length}` :
                            ...
                            {p.sizes.map((s, idx) => (
                              <motion.button key={idx} whileTap={{ scale: 0.94 }} whileHover={{ scale: 1.02 }}
                                ...
                                style={{
                                  ...
                                  background: sizeIdx === idx ? `linear-gradient(135deg, ${BLUE}, #3b7de8)` : 'rgba(255,255,255,0.05)',
                                  color: sizeIdx === idx ? '#fff' : '#7a90b8',
                                  fontWeight: 700, fontSize: 12, lineHeight: 1.5, transition: 'all 0.2s',
                ...
                {sent ? (
                  ...
                  <>
                        ...
                        <div style={{ flex: 1, position: 'relative' }}>
                          <input
                            ...
                            style={{
                              ...
                              paddingRight: 16,
                              border: promoStatus === 'ok'
                                ? '1px solid rgba(106,174,255,0.5)'
                                : promoStatus === 'error'
                                ? '1px solid rgba(255,80,80,0.4)'
                                : '1px solid rgba(255,255,255,0.07)',
                              letterSpacing: 2, fontWeight: 700, fontSize: 14,
                            }}
                          />
                        </div>
                        <motion.button
                          ...
                          style={{
                            ...
                            background: promoStatus === 'ok'
                              ? 'rgba(106,174,255,0.15)'
                              : `linear-gradient(135deg, ${BLUE}, #3b7de8)`,
                            color: promoStatus === 'ok' ? BLUE : '#fff',
                            fontWeight: 700, fontSize: 13, flexShrink: 0,
                            boxShadow: promoStatus === 'ok' ? 'none' : `0 4px 14px rgba(106,174,255,0.25)`,
                            transition: 'all 0.2s',
                          }}>
                      ...
                      <AnimatePresence>
                        {promoStatus === 'ok' && (
                          <motion.div
                            ...
                            <span style={{ color: BLUE, fontSize: 13, fontWeight: 600 }}>
                              Скидка {promoDiscount}% применена — минус {discountAmount}₽
                            </span>
                          </motion.div>
                        )}
                        {promoStatus === 'error' && (
                    ...
                    <motion.div
                      ...
                      style={{ padding: '14px 0', borderTop: `1px solid rgba(106,174,255,0.08)`, marginBottom: 20 }}>
                      {promoDiscount > 0 && (
                        <motion.div
                    ...
                    <div style={{ display: 'flex', gap: 10, marginBottom: 16 }}>
                      {[
                        ...
                        { key: 'stars', label: '⭐ Stars', sub: `${starsPrice(finalTotal)} ⭐`, active: form.payment === 'stars', color: '#a78bfa', bg: 'rgba(124,58,237,0.12)', border: 'rgba(167,139,250,0.3)' },
                      ].map(opt => (
                    ...
                    <motion.button whileTap={{ scale: 0.98 }} whileHover={{ scale: 1.01 }}
                      onClick={sendOrder} disabled={loading}
                      style={{
                        width: '100%',
